...
const RESOURCE_NAME = "Fungus";

export function loadFungalResearchBase(MR2: MR2Globals) {
  ...
  MR2.createAndLoadElementalShard("Fungus", require("./fungusShard.png"), 0.25);
}

export function preloadFungalResearchBase(MR2: MR2Globals) {
